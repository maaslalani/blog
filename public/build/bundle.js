...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-1m4witi");
    			add_location(a, file, 84, 6, 1357);
    			add_location(br, file, 85, 6, 1409);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(a, "click", /*view*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			h1 = element("h1");
    			h1.textContent = "Thinking Out Loud.";
    			t1 = space();
    			...
    			attr_dev(h1, "class", "svelte-1m4witi");
    			add_location(h1, file, 82, 42, 1279);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "svelte-1m4witi");
    			add_location(a, file, 82, 4, 1241);
    			attr_dev(div0, "id", "sidebar");
    			attr_dev(div0, "class", "svelte-1m4witi");
    			add_location(div0, file, 81, 2, 1218);
    			attr_dev(div1, "id", "article");
    			attr_dev(div1, "class", "svelte-1m4witi");
    			add_location(div1, file, 88, 2, 1439);
    			attr_dev(main, "class", "svelte-1m4witi");
    			add_location(main, file, 80, 0, 1209);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function render(post) {
    		...
    		$$invalidate(0, text = markdownToHtml(content));
    	}
    ...
    var main = app = new App({target: document.body});
